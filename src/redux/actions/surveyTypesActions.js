...
export const GetSurveyTypesList = () => {
    return dispatch => {
        axios.get('http://portalapi.asft.co/api/surveyTypes/')
        .then((response) => {
            dispatch({
...
export const LoadRelatedSurveyTypeInfoCard = (surveyTypeId) => {        
    return (dispatch) =>  {
        axios.get(`http://portalapi.asft.co/api/surveyTypes/${surveyTypeId}`)
        .then((response) => {
            dispatch({
...
export const RemoveSurveyType = (id) => {
    return dispatch => {
        axios.delete(`http://portalapi.asft.co/api/surveyTypes/${id}`)
            .then(() => {
                dispatch({
...
export const AddSurveyType = surveyType => {
    return dispatch => {
        axios.post("http://portalapi.asft.co/api/surveyTypes/", surveyType)
            .then(res => {
                dispatch({
...
// GET SURVEYTYPE MODAL
 export const GetSurveyTypesModal = (id) => {
    return dispatch => {
        axios.get(`http://portalapi.asft.co/api/surveyTypes/${id}`)
        .then((response) => {
            dispatch({
...
export const EditSurveyType = surveyType => {
    return dispatch => {
        axios.put(`http://portalapi.asft.co/api/surveyTypes/${surveyType.id}/`, surveyType)
            .then(resonse => {
                dispatch({
