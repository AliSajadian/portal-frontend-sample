...
export const GetCompaniesList = () => {
    return dispatch => {
        axios.get('http://portalapi.asft.co/api/companies/')
        .then((response) => {
            dispatch({
...
export const LoadRelatedCompanyInfoCard = (companyId) => {        
    return (dispatch) =>  {
        axios.get(`http://portalapi.asft.co/api/companies/${companyId}`)
        .then((response) => {
            dispatch({
...
export const RemoveCompany = (id) => {
    return dispatch => {
        axios.delete(`http://portalapi.asft.co/api/companies/${id}`)
            .then(() => {
                dispatch({
...
export const AddCompany = company => {
    return dispatch => {
        axios.post("http://portalapi.asft.co/api/companies/", company)
            .then(res => {
                dispatch({
...
// GET Company MODAL
 export const GetCompaniesModal = (id) => {
    return dispatch => {
        axios.get(`http://portalapi.asft.co/api/companies/${id}`)
        .then((response) => {
            dispatch({
...
export const EditCompany = company => {
    return dispatch => {
        axios.put(`http://portalapi.asft.co/api/companies/${company.id}/`, company)
            .then(resonse => {
                dispatch({
