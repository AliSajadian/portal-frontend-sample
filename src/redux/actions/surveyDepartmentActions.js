...
export const GetSurveyDepartmentsList = () => {
    return dispatch => {
        axios.get('http://portalapi.asft.co/api/surveydepartment/')
        .then((response) => {
            dispatch({
...
export const LoadRelatedSurveyDepartmentInfoCard = (id) => {        
    return (dispatch) =>  {
        axios.get(`http://portalapi.asft.co/api/surveydepartment/${id}`)
        .then((response) => {
            dispatch({
...
export const RemoveSurveyDepartment = (id) => {
    return dispatch => {
        axios.delete(`http://portalapi.asft.co/api/surveydepartment/${id}`)
            .then(() => {
                dispatch({
...
export const AddSurveyDepartment = surveyDepartment => {
    return dispatch => {
        axios.post("http://portalapi.asft.co/api/surveydepartment/", surveyDepartment)
            .then(res => {
                dispatch({
...
export const EditSurveyDepartment = surveyDepartment => {
    return dispatch => {
        axios.put(`http://portalapi.asft.co/api/surveydepartment/${surveyDepartment.id}/`, surveyDepartment)
            .then(resonse => {
                dispatch({
