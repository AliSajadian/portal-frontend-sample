...
export const GetGroupsList = () => {
    return dispatch => {
        axios.get('http://portalapi.asft.co/api/groups/')
        .then((response) => {
            dispatch({
...
export const GetUserGroupsList = () => {
    return dispatch => {
        axios.get('http://portalapi.asft.co/api/usergroups/')
        .then((response) => {
            dispatch({
...
export const LoadRelatedGroupInfoCard = (groupId) => {        
    return (dispatch) =>  {
        axios.get(`http://portalapi.asft.co/api/groups/${groupId}`)
        .then((response) => {
            dispatch({
...
export const RemoveGroup = (id) => {
    return dispatch => {
        axios.delete(`http://portalapi.asft.co/api/groups/${id}`)
            .then(() => {
                dispatch({
...
export const AddGroup = group => {
    return dispatch => {
        axios.post("http://portalapi.asft.co/api/groups/", group)
            .then(res => {
                dispatch({
...
// GET GROUP MODAL
 export const GetGroupsModal = (id) => {
    return dispatch => {
        axios.get(`http://portalapi.asft.co/api/groups/${id}`)
        .then((response) => {
            dispatch({
...
export const EditGroup = group => {
    return dispatch => {
        axios.put(`http://portalapi.asft.co/api/groups/${group.id}/`, group)
            .then(resonse => {
                dispatch({
  ...
  export const EditUserGroup = userGroup => {
    return dispatch => {
        axios.put(`http://portalapi.asft.co/api/auth/usergroups/${userGroup.id}`, userGroup)
        .then((response) => {
            dispatch({
