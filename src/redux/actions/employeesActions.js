...
export const GetEmployeesList = () => {
    return dispatch => {
        axios.get('http://172.20.20.45:90/api/employees/')
        .then((response) => {
            dispatch({
...
export const GetEmployeeCodesList = () => {
    return dispatch => {
        axios.get('http://172.20.20.45:90/api/employeecodes/')
        .then((response) => {
            dispatch({
...
export const GetDoctorEmployeesList = () => {
    return dispatch => {
        axios.get('http://172.20.20.45:90/api/doctoremployees/')
        .then((response) => {
            dispatch({
                type : types.GET_EMPLOYEES_LIST , 
                employees : response.data
...
export const LoadRelatedEmployeeInfoCard = (employeeId) => {        
    return (dispatch) =>  {
        axios.get(`http://172.20.20.45:90/api/employees/${employeeId}`)
        .then((response) => {
            dispatch({
...
export const RemoveUser = (id) => {
    return dispatch => {
        axios.delete(`http://172.20.20.45:90/api/users/${id}`)
            .then(() => {
                dispatch({
...
export const RemoveEmployee = (id) => {
    return dispatch => {
        axios.delete(`http://172.20.20.45:90/api/employees/${id}`)
            .then(() => {
                dispatch({
...
export const AddEmployee = employee => { 
    return dispatch => {
        axios.post("http://172.20.20.45:90/api/employees/", employee)
            .then(res => {
                dispatch({
...
// GET Employee MODAL
 export const GetEmployeesModal = (id) => { 
    return dispatch => {
        axios.get(`http://172.20.20.45:90/api/employees/${id}`)
        .then((response) => {
            dispatch({
...
export const EditEmployee = employee => {      console.log("employee.id: ", employee.id)
    ...
    return dispatch => {
        axios.put(`http://172.20.20.45:90/api/employees/${employee.id}/`, employee)
            .then(resonse => {
                dispatch({
...
export const EditEmployeeEx = (id, employee) => {      
    return dispatch => {
        axios.put(`http://172.20.20.45:90/api/employees/${id}/`, employee)
            .then(resonse => {
                dispatch({
                type: types.EDIT_EMPLOYEE,
                payload: resonse.data
