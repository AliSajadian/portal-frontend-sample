    ...
    {/* <Collapse isOpen={isOpen} size='lg'> rounded-circle*/}
        ...
        <Col sm={{ size: 'auto', offset: 1 }}>
            <Card className="link-card" dir="rtl">
              ...
              <CardBody>
                <a href="http://asto.ir/" target="_blank" rel="noopener noreferrer" style={{textDecoration:"none"}}>
          ...
          <Col sm={{ size: 'auto', offset: 1 }}>
            <Card className="link-card" dir="rtl">
              ...
              <CardBody>
              <a href="http://mail.asto.ir" target="_blank" rel="noopener noreferrer" style={{textDecoration:"none"}}>
                  <div className="button">
                  <span >ورود</span>
                  </div>
                </a>                   
