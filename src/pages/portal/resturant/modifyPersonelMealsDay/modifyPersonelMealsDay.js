...
class ModifyPersonelMealsDay extends Component {
  constructor(props){
    super(props)
  ...
  render() {
    ...
    const {meals, mealsDays, currentMonthDates} = this.props
    return (
      ...
      <Card style={{direction:'rtl'}} className='card3D'>
        ...
        <Container>
          ...
          currentMonthDates.filter(currentMonthDate => (Number(this.getPersianMonthWeekNo(currentMonthDate.date)) === 1))
                                      ...
                                      />
                                    //   meals={this.filteredMeals(currentMonthDate.date)} 
                                    //   mealsDays={this.filteredMealsDay(currentMonthDate.date)} 
                                    //   personelMealDays={this.filteredPersonelMealsDay(currentMonthDate.date)}                                       
             )) : ""}
            </Card>
            <Card className="card-res-week">
          {currentMonthDates && currentMonthDates.length > 0 ? 
